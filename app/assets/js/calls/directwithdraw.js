jQuery(document).ready(function() {
    ...
    jQuery('#sendreq').click(function() {
        ...
        var bankcode = String(jQuery('#BankCode').val());
        var bankaccountname = String(jQuery('#BankAccountName').val());
        var bankaccountnumber = String(jQuery('#BankAccountNo').val());
        // var bankcode = String(jQuery('#BankCode').children(':selected').val());
        ...
        if (intendedLoop > 0) {
            for (var itr = 0; itr < intendedLoop; itr++) {
                ...
                var raw = amount + orderDate + orderNumber + bankcode + currency + callbackUrl + notes;
    ...
    //                 banks.append(jQuery("<option />").val(this.Code).text(this.Name));
    //             });
    //         }
    //     });
    // }
